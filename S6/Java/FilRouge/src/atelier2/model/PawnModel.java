...
public class PawnModel extends AbstractPieceModel implements PieceModel, Promotable {
    ...
    /**
     * Dans notre contexte les PieceModel sont soit des PawnModel soit des
     * QueenModel
     * donc la promotion d'un PawnModel suppose sa destruction et la cr�ation d'une
     * QueenModel
     * Dans d'autre contexte, on aurait pu imaginer lui changer sa strat�gie de
     * d�placement
     */
    @Override
    public void promote() {
