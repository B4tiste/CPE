...
public class PawnModel extends AbstractPieceModel implements PieceModel, Promotable{
	 ...
	 * donc la promotion d'un PawnModel suppose sa destruction et la cr�ation d'une QueenModel
	 * Dans d'autre contexte, on aurait pu imaginer lui changer sa strat�gie de d�placement 
	 */
	@Override
	public void promote() {
