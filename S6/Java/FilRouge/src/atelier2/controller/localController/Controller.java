 ...
 * 
 *         La view et le model ne g�rant pas les coordonn�es des cases de la
 *         m�me mani�re
...
public class Controller implements Mediator, BoardGame<Integer>, EventHandler<MouseEvent> {
    ...
    // Elle doit �tre conserv�e pour �tre utilis�e lorsque l'utilisateur clique sur
    // une case
    ...
    /**
     * Invoque m�thode moveCapturePromote() du model (apr�s transformation des
     * coordonn�es)
     ...
     * @param squareIndex
     * @param length
     * @return les coordonn�es m�tier calcul�es � partir de l'index du SquareGUI
     *         sous la PieceGUI
     */
