...
public class TestModel {
    ...
    public static void main(String[] args) {
        ...
        pieceModel1.move(new Coord('b', 6)); // On déplace la piece en b/6
        System.out.println("pieceModel1 après déplacement = " + pieceModel1); // [B[6,b]]
        System.out.println("isMoveOk ('b',4) --> ('c',5) = "
                + pieceModel2.isMoveOk(new Coord('c', 5), false)); // true : depl. de 1 case
        // sans prise
        System.out.println("isMoveOk ('e',7) --> ('d',6) = "
                + pieceModel3.isMoveOk(new Coord('d', 6), false)); // true : depl. de 1 case
        // sans prise
        pieceModel2.move(new Coord('c', 5));
        pieceModel3.move(new Coord('d', 6));
        System.out.println("isMoveOk ('c',5) --> ('e',7) = "
                + pieceModel2.isMoveOk(new Coord('e', 7), true)); // true : depl. de 2 cases
        // avec prise
        System.out.println("isMoveOk ('c',5) --> ('d',6) = "
                + pieceModel2.isMoveOk(new Coord('d', 6), true)); // false : depl. de 1 case
        // avec prise
        // System.out.println("isMoveOk ('c',5) --> ('b',6) = "
        // + pieceModel2.isMoveOk(new Coord('b',6),true)); // false : depl. de 1 case
        // avec prise
        // System.out.println("isMoveOk ('c',5) --> ('e',7) = "
        // + pieceModel2.isMoveOk(new Coord('e',7),false)); // false : depl. de 2 cases
        // sans prise
        // System.out.println("hasThisCoord ('c',5) = "
        // + pieceModel2.hasThisCoord(new Coord('c',5))); // true : ('c',5) = Coord de
        // l'objet r�f�renc� par pieceModel2
        //
        //
        // //////////////////////////////////
